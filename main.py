...
class AppWindow:
    ...
    def update_view(self, intrinsics, extrinsic, width, height):

        # self._scene.scene.camera.

        self._scene.scene.camera.set_projection(intrinsics, 0.1, 100, width, height)

        #
        # https://github.com/intel-isl/Open3D/blob/master/cpp/open3d/visualization/visualizer/ViewControl.cpp#L224-L228
        #
...
def main():
    ...
    w = AppWindow(width, height)

    # add point cloud
    w.add_geometry(pcd)

    # change view point
    w.update_view(intrinsic, extrinsic, width, height)
